...
export const exchangePublicToken = async ({
    ...
    try {
        ...
        // Get account informaion from Plaid using the access token
        ...
        // Create a bank account using the user ID, item ID, acount ID, access token, funding source URL, and sharable ID
